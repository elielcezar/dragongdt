...
function dragongdt_textarea($element) {
...
function dragongdt_menu_tree(&$variables) {
 return '<ul class="nav nav-pills nav-stacked">' . $variables['tree'] . '</ul>';
}
function dragongdt_menu_tree__main_menu(&$variables) {
 return '<ul class="nav navbar-nav">' . $variables['tree'] . '</ul>';
}
function dragongdt_menu_link(array $variables) {
